            ...
            setTimeout(function(){
                ...
                b(f).css(d);
                  b.isFunction(c.afterLoad) && c.afterLoad.call(this, l, g + 1);
                     ...
                     k = !1;
                    b.isFunction(e) && e.call(this);
                    if($("#superContainer .active").index()==0){
                        $("#fullPage-nav").hide();
                    }else{
                       $("#fullPage-nav").show(); 
                       $("#fullPage-nav li").eq(0).hide();
                    }
                    $("#superContainer .active").animate({"opacity":1},function(){
                        $("#superContainer .section").not(".active").animate({"opacity":0});
                    });
                    // $("#superContainer .section").not(".active").animate("opacity",1,function(){
                        
                        
                    //     //console.log($("#superContainer .section").not(".active"));
                        
                    //      if(aaa==0){
                    //         $("#superContainer .active").animate({"opacity":1});
                    //          aaa++;
                    //      }
                    //       $("#superContainer .section").not(".active").animate({"opacity":0});
